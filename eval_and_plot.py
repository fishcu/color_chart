...
# Define a custom marker with an 'X'
def custom_marker(x, y, size, color):
    plt.scatter(x, y, s=size, c=color, marker='o')  # Round, filled marker
    plt.scatter(x, y, s=size, c='black', marker='x')  # X through the marker
